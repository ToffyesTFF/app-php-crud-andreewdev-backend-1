...
<body>
    <div class="container">
        ...
        <section>
            ...
            <?php
            // Aseguramos la zona horaria para la función date()
            date_default_timezone_set('America/Lima'); 

            $hora_actual_string = date("H:i");
            $hora_limite_string = "13:15";

            // Usamos objetos DateTime para una comparación robusta de tiempo
            // Nota: La comparación de strings "H:i" también funciona la mayoría de las veces
        ...
        <section>
            ...
            $puntaje = 65;
            if ($puntaje >= 70) {
                echo "IF-ELSE: Aprobado. \n";
            } else {
                echo "IF-ELSE: Reprobado. \n"; // Ejecuta este
            }
            ...
            echo "Indexado: Primera película: " . $peliculas[0] . "\n";
